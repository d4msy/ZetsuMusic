...
### Get to know about all these vars in depth from our Docs. [Read Now from Here](https://notreallyshikhar.gitbook.io/ZetsuMusicbot/config-vars/available-vars)
...
### How to get these? [Read from here](https://notreallyshikhar.gitbook.io/ZetsuMusicbot/deployment/spotify)
