...
1. Clone the repo
   ...
   ```sh
   git clone https://github.com/TeamYukki/ZetsuMusicBot
   ```
...
1. Search our repository for open or closed
   [Pull Requests](https://github.com/TeamYukki/ZetsuMusicBot/pulls)
...
6. [Open a Pull Request](https://github.com/TeamYukki/ZetsuMusicBot/compare?expand=1)
