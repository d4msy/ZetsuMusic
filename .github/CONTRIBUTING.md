...
1. Clone the repo
   ...
   ```sh
   git clone https://github.com/damsyx/zetsumusicBot
   ```
...
1. Search our repository for open or closed
   [Pull Requests](https://github.com/damsyx/zetsumusicBot/pulls)
...
6. [Open a Pull Request](https://github.com/damsyx/zetsumusicBot/compare?expand=1)
